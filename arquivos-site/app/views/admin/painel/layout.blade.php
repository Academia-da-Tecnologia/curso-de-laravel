...
<body>
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                - Você está logado como <span style="color:#900;">{{ Auth::user()->tb_user_nome }}</span>
                </span></b></a>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                @if(empty(Auth::user()->tb_user_foto))
                   <a href="/foto/create">Adicione uma foto</a> 
                @else
                    <img src="{{ asset(Auth::user()->tb_user_foto) }}" width="50" height="40">
                @endif
                <!-- /.dropdown -->
                <li class="dropdown">
    ...
    <script src="{{ URL::asset('tinymce/tinymce/tinymce.min.js') }}"></script>
      <script src="{{ URL::asset('js/admin/tinyInit.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/admin/plugins/dataTables/jquery.dataTables.js') }}"></script>
    <script src="{{ URL::asset('js/admin/plugins/dataTables/dataTables.bootstrap.js') }}"></script>
    <script src="{{ URL::asset('js/admin/LoadDatatables.js') }}"></script>
    <script src="{{ URL::asset('js/admin/posts.js') }}"></script>
